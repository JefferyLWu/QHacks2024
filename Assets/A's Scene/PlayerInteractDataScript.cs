...
public class PlayerInteractDataScript : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetKeyDown(KeyCode.E) && canInteract[0] == true)
        {
            ...
            { // figure this out later
                ...
                ScoreManagerScript.Instance.AddCountIncomplete();
            }
            catch (Exception E)
            {
        ...
        } else if (Input.GetKeyDown(KeyCode.Q) && canInteract[1] == true)
        {
            ...
            try
            {
                ...
                ScoreManagerScript.Instance.AddCountCorrupted();
            }
            catch (Exception E)
            {
    ...
    {
        if (!(collider.gameObject.name == "ExitObject") && !(collider.gameObject.name.Contains("Border")))
        {
            int index = 0;
